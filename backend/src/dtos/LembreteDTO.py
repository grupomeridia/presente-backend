...
class LembreteDTO:
    @validate_arguments
    def __init__(self, id_secretaria:int, destinatario_cargo:Cargo, destinatario_id:int, titulo:str, mensagem:str, criacao:datetime, visualizacao:Optional[datetime] = None):
