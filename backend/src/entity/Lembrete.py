...
class Lembrete(MainRepository.db.Model):
    ...
    destinatario_cargo = MainRepository.db.Column(MainRepository.db.Enum(Cargo))
    destinatario_id = MainRepository.db.Column(MainRepository.db.Integer, nullable=False)
