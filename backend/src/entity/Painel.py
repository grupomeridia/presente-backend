...
class Painel(db.Model):
    ...
    def __init__(self, id_configuracao:int, id_secretaria:int, status:bool, data_criado:datetime, total_ativo:int, total_presentes:int, total_ausentes:int, total_presentes_curso:int, total_ativo_curso:int, total_ausente_curso:int):
